...
{
    public static readonly string TempDirectory = System.IO.Path.Combine(
    ...
    private Commands.ICommand CreateCommand(string[] args)
    {
    ...
    {
        return System.IO.Path.Combine(TempDirectory, System.IO.Path.GetRandomFileName());
    }
